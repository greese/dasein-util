...
public class GroupTag extends TagSupport {
    ...
    public void setAttribute(String attr) throws JspException {
        attribute = (new ELParser(attr)).getStringValue(pageContext);
    }
    
    public void setList(String l) throws JspException {
        list = (Collection<?>)(new ELParser(l)).getValue(pageContext);
    }
