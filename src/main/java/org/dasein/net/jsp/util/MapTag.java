...
public class MapTag extends TagSupport {
    ...
    public void setKey(String k) throws JspException {
        key = (new ELParser(k)).getStringValue(pageContext);
    }
    
    @SuppressWarnings("unchecked")
    public void setItems(String it) throws JspException {
        items = (Collection<Object>)(new ELParser(it)).getValue(pageContext);
    }
