...
public class DataSizeTag  extends TagSupport {
    ...
    public void setMetric(String m) throws JspException {
        metric = (new ELParser(m)).getStringValue(pageContext);
        if( metric != null ) {
            if( metric.equals("") ) {
                metric = null;
            }
    ...
    public void setSize(String s) throws JspException {
        Number num = (new ELParser(s)).getNumberValue(pageContext);
