...
public class TypeValueTag extends TagSupport {
    ...
    public void setItem(String itm) throws JspException {
        item = (new ELParser(itm)).getValue(pageContext);
    }
    
    public void setLocale(String loc) throws JspException {
        locale = (Locale)(new ELParser(loc)).getValue(pageContext);
    }
    ...
    public void setVarDisplay(String v) throws JspException {
        varDisplay = v;
    }
